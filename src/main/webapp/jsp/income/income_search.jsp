  ...
  <form class="layui-form" id="formLayer" onsubmit="return false">
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="iCode"  name="iCode" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off">
        </div>
      </div>
      <div class="layui-inline">
        <label class="layui-form-label">日期</label>
        <div class="layui-input-inline" style="width: 515px">
          <input type="text" class="layui-input" id="iDate" name="iDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off">
        </div>
      </div>
    </div>
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="iQty"  name="iQty" lay-verify="required|number" autocomplete="off">
        </div>
      </div>
      <div class="layui-inline">
        <label class="layui-form-label">金额</label>
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="iMoney"  name="iMoney" lay-verify="required|number" autocomplete="off">
        </div>
      </div>
    </div>
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="iType"  name="iType" lay-verify="required" autocomplete="off">
        </div>
      </div>
      <div class="layui-inline">
        <label class="layui-form-label">方式</label>
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="iMethod"  name="iMethod" lay-verify="required" autocomplete="off">
        </div>
      </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
      ...
      <div class="layui-input-inline" style="width: 515px">
        <textarea class="layui-textarea" id="iInfo"  name="iInfo" placeholder="请输入内容"></textarea>
      </div>
    </div>
  </form>
</div>
            ...
            switch(obj.event){
                ...
                case 'layTable_Add':
                    layer.open({
                        ...
                        ,yes: function(index){
                            $.getJSON('${pageContext.request.contextPath}/income/insertIncomeBody',{
                                iCode: $('#iCode').val()
                                ,iDate: $('#iDate').val()
                                ,fCode: $('#fCode').val()
                                ,mCode: $('#mCode').val()
            ...
            if(layEvent === 'detail'){
                ...
                layer.open({
                    ...
                    ,success: function () {
                        ...
                        $('#iDate').val(data.iDate);
                        $('#fCode').val(data.fCode);
                        $('#mCode').val(data.mCode);
                        $('#iQty').val(data.iQty);
                        $('#iMoney').val(data.iMoney);
                        $('#iMethod').val(data.iMethod);
                        $('#iInfo').val(data.iInfo);
                    }
                    ,yes: function(index){
                        $.getJSON('${pageContext.request.contextPath}/income/modifyIncomeBody',{
                            iCode: $('#iCode').val()
                            ,iDate: $('#iDate').val()
                            ,fCode: $('#fCode').val()
                            ,mCode: $('#mCode').val()
