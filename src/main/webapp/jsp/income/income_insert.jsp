...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>收入信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertIncome" lay-filter="demoForm" id=""  name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">编号</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="iCode"  name="iCode" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['income'].iCode}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">日期</label>
      <div class="layui-input-inline" style="width: 515px">
        <input type="text" class="layui-input" id="iDate" name="iDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['income'].iDate}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="fCode" name="fCode" lay-verify="required|number" autocomplete="off" value="${message['income'].fCode}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">成员</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="mCode" name="mCode" lay-verify="required" autocomplete="off" value="${message['income'].mCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="iQty"  name="iQty" lay-verify="required|number" autocomplete="off" value="${message['income'].iQty}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">金额</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="iMoney"  name="iMoney" lay-verify="required|number" autocomplete="off" value="${message['income'].iMoney}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="iMethod"  name="iMethod" lay-verify="required" autocomplete="off" value="${message['income'].iMethod}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="iInfo"  name="iInfo" placeholder="请输入内容" value="${message['income'].iInfo}"></textarea>
    </div>
  </div>
