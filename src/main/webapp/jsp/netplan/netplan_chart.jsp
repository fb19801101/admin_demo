...
<script src="${pageContext.request.contextPath}/res/js/jquery-3.5.1/jquery.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jquery-ui-1.12.1/jquery-ui.js"></script>

<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
