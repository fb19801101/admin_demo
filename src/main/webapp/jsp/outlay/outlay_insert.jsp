...
<form class="layui-form" method="POST" action="insertOutlay" lay-filter="demoForm" id=""  name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">编号</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="oCode"  name="oCode" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['outlay'].oCode}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">日期</label>
      <div class="layui-input-inline" style="width: 515px">
        <input type="text" class="layui-input" id="oDate" name="oDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['outlay'].oDate}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="fCode" name="fCode" lay-verify="required|number" autocomplete="off" value="${message['outlay'].fCode}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">成员</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="mCode" name="mCode" lay-verify="required" autocomplete="off" value="${message['outlay'].mCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="oQty"  name="oQty" lay-verify="required|number" autocomplete="off" value="${message['outlay'].oQty}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">金额</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="oMoney"  name="oMoney" lay-verify="required|number" autocomplete="off" value="${message['outlay'].oMoney}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="oMethod"  name="oMethod" lay-verify="required" autocomplete="off" value="${message['outlay'].oMethod}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="oInfo"  name="oInfo" placeholder="请输入内容" value="${message['outlay'].oInfo}"></textarea>
    </div>
  </div>
