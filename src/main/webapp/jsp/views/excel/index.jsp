...
<head>
	...
	<script src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/excel/demo/index.js"></script>
</head>
<body>
	...
	<div class="layui-row">
		<div class="layui-col-md11 layui-col-md-offset1">
			...
			<blockquote class="layui-elem-quote">
				...
				<b>非Layui框架支持：</b><br>
						通过全局变量 LAY_EXCEL 调用函数，具体可见demo，<a href="index">点此进入</a>
			...
			<div class="layui-form">
				<div class="layui-form-item">
					...
					<div class="layui-form-block">
						...
						<button type="button" class="layui-btn layui-btn-primary" onclick="exportApiDemo('${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/excel/demo/json/list.json')">导出接口数据</button>
				...
				<div class="layui-form-item">
					...
					<div class="layui-form-block">
						<a class="layui-btn layui-btn-primary" href="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/excel/demo/json/test_import.xlsx">常规单元格数据</a>
						<a class="layui-btn layui-btn-primary" href="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/excel/demo/json/test_merge.xlsx">合并单元格数据</a>
					</div>
				</div>
				<div class="layui-form-item">
...
<img alt="QQ群二维码" src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/excel/demo/json/qq_group_qrcode.png" style="max-width: 100%;display:block;margin: 0 auto;">
</script>
<!--demo列表模板-->
