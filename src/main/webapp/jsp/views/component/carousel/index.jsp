        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <div class="layui-carousel" id="test-carousel-img">
              <div carousel-item="">
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/Bim.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/构想.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/看板.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/框架.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/简图.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/监控.png"></div>
                <div><img src="${pageContext.request.contextPath}/res/img/carousel/大屏.png"></div>
              </div>
            </div>
          </div>
        </div>
