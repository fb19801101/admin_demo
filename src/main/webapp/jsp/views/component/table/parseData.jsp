        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <blockquote class="layui-elem-quote layui-text">
              尽管本示例中的原始数据：<a href="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/json/table/demo3.js" target="_blank">demo3.js</a>，并不符合 table 组件默认规定的数据格式，但从 layui 2.4.0 开始，新增的 parseData 回调可以将原始的任意格式的数据重新解析成 table 组件规定的数据格式。具体可以点击上方查看代码。
            </blockquote>
