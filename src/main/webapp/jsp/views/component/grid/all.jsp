    ...
    <div class="layui-row layui-col-space10">
      <div class="layui-col-xs6 layui-col-sm7 layui-col-md3">
        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body layui-bg-green">1/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-sm5 layui-col-md3">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-blue"></div>
          <div class="layui-card-body layui-bg-green">2/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-sm5 layui-col-md3">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-blue"></div>
          <div class="layui-card-body layui-bg-green">3/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-sm7 layui-col-md3">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-blue"></div>
          <div class="layui-card-body layui-bg-green">4/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-sm7 layui-col-md9">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-blue"></div>
          <div class="layui-card-body layui-bg-cyan">1/2</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-sm5 layui-col-md3">
        <div class="layui-card">
      ...
      <div class="layui-col-xs6 layui-col-sm7 layui-col-md9">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-blue"></div>
          <div class="layui-card-body layui-bg-cyan">2/2</div>
        </div>
      </div>
    </div>
  </div>
