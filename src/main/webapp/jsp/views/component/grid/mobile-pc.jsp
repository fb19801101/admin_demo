    ...
    <div class="layui-row layui-col-space10">
      <div class="layui-col-xs6 layui-col-md8">
        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body layui-bg-red">1/2</div>
        </div>
      </div>
      ...
      <div class="layui-col-xs6 layui-col-md4">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-green"></div>
          <div class="layui-card-body layui-bg-blue">1/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-md4">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-green"></div>
          <div class="layui-card-body layui-bg-blue">2/4</div>
        </div>
      </div>
      ...
      <div class="layui-col-xs6 layui-col-md4">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-green"></div>
          <div class="layui-card-body layui-bg-blue">3/4</div>
        </div>
      </div>
      <div class="layui-col-xs6 layui-col-md4">
        <div class="layui-card">
          <div class="layui-card-header layui-bg-green"></div>
          <div class="layui-card-body layui-bg-blue">4/4</div>
        </div>
      </div>
      <div class="layui-col-xs12 layui-col-md4">
        <div class="layui-card">
