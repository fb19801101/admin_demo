        ...
        <div class="layui-card text-center">
          <div class="layui-card-body">
            <div class="layadmin-homepage-pad-ver">
              <img class="layadmin-homepage-pad-img" src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/template/portrait.png" width="96" height="96">
            </div>
            ...
            <div class="grid-demo">
              <div class="panel-body layadmin-homepage-shadow">
                ...
                <div class="media-body">
                  ...
                  <img class="h-img" src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/template/huge.jpg">
                  <div class="media">
                    ...
                    <div class="media-left">
                      <ul class="list-inline">
                        <li>
                          <a href="javascript:;">
                            <img class="img-xs" src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/template/portrait.png">
                          </a>
                        </li>
                        <li>
                          <a href="javascript:;">
                ...
                <div class="layui-card-body">
                  <div class="layui-row layui-col-space15">
                    <div class="layui-col-md4">
                      <img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/template/portrait.png">
                    </div>
                    <div class="layui-col-md4">
                      <img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/template/portrait.png">
                    </div>
