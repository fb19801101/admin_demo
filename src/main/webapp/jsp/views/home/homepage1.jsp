        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <dl class="layuiadmin-card-status">
              <dd>
                <div class="layui-status-img"><a href="javascript:;"><img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/logo.png"></a></div>
                <div>
                  <p>胡歌 在 <a lay-href="http://fly.layui.com/vipclub/list/layui-2.5.6/ext/modules/admin/">layuiadmin专区</a> 回答问题</p>
                  <span>几秒前</span>
                </div>
              </dd>
              <dd>
                <div class="layui-status-img"><a href="javascript:;"><img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/logo.png"></a></div>
                <div>
                  <p>彭于晏 在 <a lay-href="http://fly.layui.com/vipclub/list/layui-2.5.6/ext/modules/admin/">layuiadmin专区</a> 进行了 <a lay-href="http://fly.layui.com/vipclub/list/layui-2.5.6/ext/modules/admin/column/quiz/">提问</a></p>
                  <span>2天前</span>
                </div>
              </dd>
              <dd>
              ...
              <dd>
                <div class="layui-status-img"><a href="javascript:;"><img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/logo.png"></a></div>
                <div>
                  <p>小蚊子 在 <a lay-href="http://fly.layui.com/vipclub/list/layui-2.5.6/ext/modules/admin/">layuiadmin专区</a> 进行了 <a lay-href="http://fly.layui.com/vipclub/list/layui-2.5.6/ext/modules/admin/column/quiz/">提问</a></p>
                  <span>8天前</span>
                </div>
              </dd>
            </dl>  
            ...
            <ul class="layui-row layuiadmin-card-team">
              <li class="layui-col-xs6">
                <a lay-href="https://www.layui.com/doc/modules/table.html">
                  <span class="layui-team-img"><img src="${pageContext.request.contextPath}/res/js/layui-2.5.6/ext/modules/admin/style/res/logo.png"></span> 
                  <span>数据表格</span>
                </a>
              </li>
              <li class="layui-col-xs6">
