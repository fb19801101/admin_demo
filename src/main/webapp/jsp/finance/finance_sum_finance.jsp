    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline" style="width:140px; margin-top:5px;">
        <select id="conditionField" lay-verify="required" lay-search="">
          ...
          <option selected="true" value="p_code">编号</option>
          <option value="p_date">日期</option>
...
<script>
    layui.use(['layer', 'table', 'jquery'], function(){
        ...
        table.render({
            ...
            ,totalRow: true //开启合计行
            ,url: '${pageContext.request.contextPath}/finance/sumFinanceBody' // 使用url加载（可与data加载同时存在）
            ,cellMinWidth: 100
            ,event: true
            ,cols: [[{type:'numbers', title:'序号', fixed: true},{checkbox: true, fixed: true}
                ,{field:'pCode', title:'编号', width:80, sort: true, fixed: true, totalRowText: '金额合计'}
                ,{field:'pDate', title:'日期', Width:100, sort: true, fixed: true}
                ,{field:'funds', title:'款项', Width:80, sort: true, fixed: true}
                ,{field:'category', title:'类别', Width:80, sort: true, fixed: true}
                ,{field:'member', title:'成员', Width:80, sort: true, fixed: true}
                ,{field:'pQty', title:'数量', Width:100, sort: true, fixed: true}
                ,{field:'pMoney', title:'金额', Width:100, sort: true, fixed: true, totalRow: true}
                ,{field:'pType', title:'收支', Width:100, sort: true, fixed: true}
                ,{field:'pMethod', title:'方式', Width:100, sort: true, fixed: true}
                ,{field:'pInfo', title:'备注'}
                ,{fixed:'right', width:200, align:'center', toolbar:'#rowbar'}
        ...
        $("#demoDataSum").click(function(){
            table.reload('tableReloadSum', {
                method: 'post'
                ,url: '${pageContext.request.contextPath}/finance/sumFinanceBody'
                ,where: {
                    field: 'funds'
                    ,value: ''
                }
